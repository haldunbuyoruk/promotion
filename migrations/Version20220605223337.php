 ...
 */
final class Version20220605223337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_promotion (id INT NOT NULL, product_id INT DEFAULT NULL, promotion_id INT NOT NULL, valid_to TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
